...
<div class="container-fluid">
    <div class="col-lg-12 mb-4">
        <div class="card shadow h-100">
            <div class="card-header py-4 bg-gradient-info text-white d-flex flex-row align-items-center justify-content-between">
            ...
            <div class="card-footer text-center bg-light">
                ...
                <button type="button" data-toggle="modal" data-target="#edit-perpustakaan" class="btn btn-sm btn-warning px-4">Edit Data</button>
                @endif
            </div>
        </div>
    </div>
