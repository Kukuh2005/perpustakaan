...
<div class="col-md-12">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-warning d-inline">Data Laporan</h6>
            <button class="btn btn-sm btn-danger float-right d-inline" data-toggle="modal" data-target="#form-print">Print</button>
        </div>
        <div class="card-body">
