                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_ddc" class="form-control" id="id_ddc">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_format" class="form-control" id="id_format">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_pengarang" class="form-control" id="id_pengarang">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="tahun_terbit" name="tahun_terbit" min="0">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="harga_buku" name="harga_buku" min="0">
                            </div>
                            <div class="form-group">
                                <label for="denda_terlambat">Denda Terlambat</label>
                                <input type="number" class="form-control" id="denda_terlambat" name="denda_terlambat" min="0">
                            </div>
                            <div class="form-group">
                                <label for="denda_hilang">Denda Hilang</label>
                                <input type="number" class="form-control" id="denda_hilang" name="denda_hilang" min="0">
                            </div>
                            <div class="form-group">
